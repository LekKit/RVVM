...
static void riscv32i_lui(risc32_vm_state_t *vm, const uint32_t instruction)
{
...
static void riscv32i_auipc(risc32_vm_state_t *vm, const uint32_t instruction)
{
...
static void riscv32i_srli_srai(risc32_vm_state_t *vm, const uint32_t instruction)
{
...
static void riscv32i_beq(risc32_vm_state_t *vm, const uint32_t instruction)
{
...
static void riscv32i_bne(risc32_vm_state_t *vm, const uint32_t instruction)
{
    // Conditional jump when rs1 != rs2
    uint32_t rs1 = cut_bits(instruction, 15, 5);
    uint32_t rs2 = cut_bits(instruction, 20, 5);
...
static void riscv32i_blt(risc32_vm_state_t *vm, const uint32_t instruction)
{
...
static void riscv32i_bge(risc32_vm_state_t *vm, const uint32_t instruction)
{
    // Conditional jump when rs1 >= rs2 (signed)
    uint32_t rs1 = cut_bits(instruction, 15, 5);
    uint32_t rs2 = cut_bits(instruction, 20, 5);
...
static void riscv32i_bltu(risc32_vm_state_t *vm, const uint32_t instruction)
{
    // Conditional jump when rs1 > rs2
    uint32_t rs1 = cut_bits(instruction, 15, 5);
    uint32_t rs2 = cut_bits(instruction, 20, 5);
...
static void riscv32i_bgeu(risc32_vm_state_t *vm, const uint32_t instruction)
{
    // Conditional jump when rs1 >= rs2
    uint32_t rs1 = cut_bits(instruction, 15, 5);
    uint32_t rs2 = cut_bits(instruction, 20, 5);
...
static void riscv32i_lb(risc32_vm_state_t *vm, const uint32_t instruction)
{
    printf("RV32I: LB instruction 0x%x in VM %p\n", instruction, vm);
}

static void riscv32i_lh(risc32_vm_state_t *vm, const uint32_t instruction)
{
    printf("RV32I: LH instruction 0x%x in VM %p\n", instruction, vm);
}

static void riscv32i_lw(risc32_vm_state_t *vm, const uint32_t instruction)
{
    printf("RV32I: LW instruction 0x%x in VM %p\n", instruction, vm);
}

static void riscv32i_lbu(risc32_vm_state_t *vm, const uint32_t instruction)
{
    printf("RV32I: LBU instruction 0x%x in VM %p\n", instruction, vm);
}

static void riscv32i_lhu(risc32_vm_state_t *vm, const uint32_t instruction)
{
    printf("RV32I: LHU instruction 0x%x in VM %p\n", instruction, vm);
}

static void riscv32i_sb(risc32_vm_state_t *vm, const uint32_t instruction)
{
    printf("RV32I: SB instruction 0x%x in VM %p\n", instruction, vm);
}

static void riscv32i_sh(risc32_vm_state_t *vm, const uint32_t instruction)
{
    printf("RV32I: SH instruction 0x%x in VM %p\n", instruction, vm);
}

static void riscv32i_sw(risc32_vm_state_t *vm, const uint32_t instruction)
{
    printf("RV32I: SW instruction 0x%x in VM %p\n", instruction, vm);
}

static void riscv32i_addi(risc32_vm_state_t *vm, const uint32_t instruction)
{
...
static void riscv32i_slti(risc32_vm_state_t *vm, const uint32_t instruction)
{
...
static void riscv32i_sltiu(risc32_vm_state_t *vm, const uint32_t instruction)
{
...
static void riscv32i_xori(risc32_vm_state_t *vm, const uint32_t instruction)
{
...
static void riscv32i_ori(risc32_vm_state_t *vm, const uint32_t instruction)
{
...
static void riscv32i_andi(risc32_vm_state_t *vm, const uint32_t instruction)
{
...
static void riscv32i_slli(risc32_vm_state_t *vm, const uint32_t instruction)
{
...
static void riscv32i_sll(risc32_vm_state_t *vm, const uint32_t instruction)
{
...
static void riscv32i_slt(risc32_vm_state_t *vm, const uint32_t instruction)
{
...
static void riscv32i_sltu(risc32_vm_state_t *vm, const uint32_t instruction)
{
...
static void riscv32i_xor(risc32_vm_state_t *vm, const uint32_t instruction)
{
...
static void riscv32i_or(risc32_vm_state_t *vm, const uint32_t instruction)
{
...
static void riscv32i_and(risc32_vm_state_t *vm, const uint32_t instruction)
{
